...
import com.mycompany.outliner.listener.StylingListener;
...
public class Styling {
    ...
    public static Font createFont(int size, boolean bold) {
        return new Font(DEFAULT_FONT_NAME, bold ? Font.BOLD : Font.PLAIN, size);
    } 
    
    public static Color createColor(int transparency) {
        return createColor(getTheme(), transparency);
    }
    ...
    private static String getTheme() {
        return stylingListener == null ? DEFAULT_THEME : stylingListener.getTheme();
    }
